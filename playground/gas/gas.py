from data_generation.potentials import vdwgass as gas
...
def main():
    ...
    figure_title = "MLP Prediction of van der Waals Gas Potential with Noise"
    x_label = "Distance (r)"
    y_label = "Potential Energy (V)"
    markers = ['o', 'x']
    colors = ['blue', 'red']
    save_path = "vdwgas_mlp_prediction.png"
    noise_amplitude = 0.01


#   generating data
    x_measured = abscissa_gen(0.7, 3.0, 0.1)
    y_measured = gas(x_measured,
                     a=1.0,
                     b=0.2)  #
...
#   training MLP
    ...
    #    ys = [y_noisy, y_predicted]
        ...
        plot2d(xs, 
            ...
            markers=markers, 
            colors=colors, 
            save_path=f"learn_VDWGas_{i+1}.png")
